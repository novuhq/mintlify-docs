# Source: https://docs.novu.co/community
...
## [Community details](https://docs.novu.co/#community-details)
...
### [Getting involved](https://docs.novu.co/#getting-involved)
...
## [Novu Cloud, or Novu Project?](https://docs.novu.co/#novu-cloud-or-novu-project)
...
[See the full list of differences between Novu Cloud and Novu.](https://docs.novu.co/community/self-hosted-and-novu-cloud)

## [Using Novu](https://docs.novu.co/#using-novu)

There are two ways to get started with Novu.

### [1\. Create a free account in our hosted Novu Cloud service](https://docs.novu.co/#1-create-a-free-account-in-our-hosted-novu-cloud-service)
...
### [2\. Self-host](https://docs.novu.co/#2-self-host)
...
## [Get help](https://docs.novu.co/#get-help)

For assistance with a Paid or Trial Novu Cloud account? Please use the in-app chat widget which is available in the lower right hand corner of the Novu Dashboard after you sign in. 🙂
...
[Overview\\ \\ Self-host Novu for full control over your notification infrastructure. Covers system requirements, VMs, Redis, MongoDB, and storage.](https://docs.novu.co/community/self-hosting-novu/overview)

### On this page

[Community details](https://docs.novu.co/#community-details) [Getting involved](https://docs.novu.co/#getting-involved) [Novu Cloud, or Novu Project?](https://docs.novu.co/#novu-cloud-or-novu-project) [Using Novu](https://docs.novu.co/#using-novu) [1\. Create a free account in our hosted Novu Cloud service](https://docs.novu.co/#1-create-a-free-account-in-our-hosted-novu-cloud-service) [2\. Self-host](https://docs.novu.co/#2-self-host) [Get help](https://docs.novu.co/#get-help) [Events](https://docs.novu.co/#events)

Copy page as markdown[Edit this page on GitHub](https://github.com/novuhq/docs/edit/main/content/docs/community/index.mdx)Open in ChatGPTOpen in Claude