...
## [Why Use Novu with Inngest?](https://docs.novu.co/#why-use-novu-with-inngest)
...
## [Trigger Notification Workflow from an Inngest function](https://docs.novu.co/#trigger-notification-workflow-from-an-inngest-function)
...
### [Adding Dynamic Content with `payload`](https://docs.novu.co/#adding-dynamic-content-with-payload)
...
### [Trigger Example with Payload](https://docs.novu.co/#trigger-example-with-payload)
...
## [Add a New Subscriber to Novu](https://docs.novu.co/#add-a-new-subscriber-to-novu)

Before sending notifications, Novu needs to know _who_ to notify. That's where subscribers come in. A **subscriber** in Novu represents a user (or entity) that can receive notifications through one or more channels (in-app, email, SMS, etc.).

You can create a new subscriber programmatically from a Inngest's task using Novu's SDK.

---

### [When Should You Create Subscribers?](https://docs.novu.co/#when-should-you-create-subscribers)
...
### [Create a Subscriber in a Task](https://docs.novu.co/#create-a-subscriber-in-a-task)
...
## [Implementation Example](https://docs.novu.co/#implementation-example)
...
### [Template Usage Example](https://docs.novu.co/#template-usage-example)
...
[Overview\\ \\ Step-by-step guides for integrating Novu with popular services like Clerk, Stripe, and Segment.](https://docs.novu.co/guides) [Trigger.dev\\ \\ Integrate Novu with Trigger.dev to send notifications from background jobs. Covers setup, subscribers, and practical examples.](https://docs.novu.co/guides/triggerdotdev)

### On this page

[Why Use Novu with Inngest?](https://docs.novu.co/#why-use-novu-with-inngest) [What You'll Learn](https://docs.novu.co/#what-youll-learn) [Trigger Notification Workflow from an Inngest function](https://docs.novu.co/#trigger-notification-workflow-from-an-inngest-function) [Core Requirements](https://docs.novu.co/#core-requirements) [Basic Trigger Example](https://docs.novu.co/#basic-trigger-example) [Adding Dynamic Content with `payload`](https://docs.novu.co/#adding-dynamic-content-with-payload) [Trigger Example with Payload](https://docs.novu.co/#trigger-example-with-payload) [Add a New Subscriber to Novu](https://docs.novu.co/#add-a-new-subscriber-to-novu) [When Should You Create Subscribers?](https://docs.novu.co/#when-should-you-create-subscribers) [Create a Subscriber in a Task](https://docs.novu.co/#create-a-subscriber-in-a-task) [Implementation Example](https://docs.novu.co/#implementation-example) [Template Usage Example](https://docs.novu.co/#template-usage-example) [Best Practices](https://docs.novu.co/#best-practices)

Copy page as markdown[Edit this page on GitHub](https://github.com/novuhq/docs/edit/main/content/docs/guides/inngest.mdx)Open in ChatGPTOpen in Claude