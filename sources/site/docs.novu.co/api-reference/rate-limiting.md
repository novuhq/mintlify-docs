# Source: https://docs.novu.co/api-reference/rate-limiting
...
[Overview\\ \\ Complete Novu API reference covering authentication, endpoints, rate limits, and server-side integration for notifications.](https://docs.novu.co/api-reference) [Idempotency\\ \\ Learn how to use idempotency keys to safely retry API requests without causing duplicate operations](https://docs.novu.co/api-reference/idempotency)

### On this page

[Limits](https://docs.novu.co/#limits) [HTTP response headers](https://docs.novu.co/#http-response-headers)

Copy page as markdown[Edit this page on GitHub](https://github.com/novuhq/docs/edit/main/content/docs/api-reference/rate-limiting.mdx)Open in ChatGPTOpen in Claude