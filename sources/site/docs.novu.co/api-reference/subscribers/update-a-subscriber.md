# Source: https://docs.novu.co/api-reference/subscribers/update-a-subscriber
...
[Retrieve a subscriber GET\\ \\ Retrieve a subscriber by its unique key identifier \*\*subscriberId\*\*. \*\*subscriberId\*\* field is required.](https://docs.novu.co/api-reference/subscribers/retrieve-a-subscriber) [Delete a subscriber DELETE\\ \\ Deletes a subscriber entity from the Novu platform along with associated messages, preferences, and topic subscriptions. \*\*subscriberId\*\* is a required field.](https://docs.novu.co/api-reference/subscribers/delete-a-subscriber)

### On this page

No Headings

Copy page as markdown[Edit this page on GitHub](https://github.com/novuhq/docs/edit/main/content/docs/api-reference/subscribers/update-a-subscriber.mdx)Open in ChatGPTOpen in Claude