...
[Chat\\ \\ Learn the process of configuring and using chat providers with Novu](https://docs.novu.co/framework/chat-channel) [Remix & React Email\\ \\ Learn how to integrate React Email with Novu Framework in a Remix application](https://docs.novu.co/framework/content/remix-react-email)

### On this page

[Getting Started](https://docs.novu.co/#getting-started)

Copy page as markdown[Edit this page on GitHub](https://github.com/novuhq/docs/edit/main/content/docs/framework/content/react-email.mdx)Open in ChatGPTOpen in Claude