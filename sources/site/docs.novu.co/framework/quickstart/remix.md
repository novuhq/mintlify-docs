# Source: https://docs.novu.co/framework/quickstart/remix

Quickstart

# Remix Framework Quickstart Guide

Get started with Novu Framework in a Remix application

In this guide, we will add a Novu [Bridge Endpoint](https://docs.novu.co/framework/endpoint) to a Remix application and send our first test workflow.
...
[Express\\ \\ Get started with Novu Framework in an Express application](https://docs.novu.co/framework/quickstart/express) [NestJS\\ \\ Get started with Novu Framework in a NestJS application](https://docs.novu.co/framework/quickstart/nestjs)
...
Copy page as markdown[Edit this page on GitHub](https://github.com/novuhq/docs/edit/main/content/docs/framework/quickstart/remix.mdx)Open in ChatGPTOpen in Claude