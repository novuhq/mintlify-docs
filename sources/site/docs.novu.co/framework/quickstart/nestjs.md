# Source: https://docs.novu.co/framework/quickstart/nestjs

Quickstart

# NestJS Framework Quickstart Guide

Get started with Novu Framework in a NestJS application

In this guide, we will add a Novu [Bridge Endpoint](https://docs.novu.co/framework/endpoint) to a NestJS application and send our first test workflow.
...
The following example does not support NestJS dependency injection. If you need to `@Injectable` dependencies in your workflow definition, see [Advanced Usage](https://docs.novu.co/#advanced-usage-dependency-injection).
...
## [Advanced Usage (Dependency Injection)](https://docs.novu.co/#advanced-usage-dependency-injection)
...
[Remix\\ \\ Get started with Novu Framework in a Remix application](https://docs.novu.co/framework/quickstart/remix) [SvelteKit\\ \\ Get started with Novu Framework in a SvelteKit application](https://docs.novu.co/framework/quickstart/svelte)

### On this page

[Set up your local environment](https://docs.novu.co/#set-up-your-local-environment) [Install packages](https://docs.novu.co/#install-packages) [Configure your secret key](https://docs.novu.co/#configure-your-secret-key) [Create your workflow definition](https://docs.novu.co/#create-your-workflow-definition) [Start your application](https://docs.novu.co/#start-your-application) [Test your endpoint](https://docs.novu.co/#test-your-endpoint) [Deploy your application](https://docs.novu.co/#deploy-your-application) [Advanced Usage (Dependency Injection)](https://docs.novu.co/#advanced-usage-dependency-injection)

Copy page as markdown[Edit this page on GitHub](https://github.com/novuhq/docs/edit/main/content/docs/framework/quickstart/nestjs.mdx)Open in ChatGPTOpen in Claude