...
# Express.js Framework Quickstart Guide

Get started with Novu Framework in an Express application

In this guide, we will add a Novu [Bridge Endpoint](https://docs.novu.co/framework/endpoint) to a Express.js application and send our first test workflow.
...
[Next.js\\ \\ Get started with Novu Framework in a Next.js application](https://docs.novu.co/framework/quickstart/nextjs) [Remix\\ \\ Get started with Novu Framework in a Remix application](https://docs.novu.co/framework/quickstart/remix)
...
Copy page as markdown[Edit this page on GitHub](https://github.com/novuhq/docs/edit/main/content/docs/framework/quickstart/express.mdx)Open in ChatGPTOpen in Claude