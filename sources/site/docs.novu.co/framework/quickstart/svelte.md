# Source: https://docs.novu.co/framework/quickstart/svelte

Quickstart

# SvelteKit Framework Quickstart Guide

Get started with Novu Framework in a SvelteKit application

In this guide, we will add a Novu [Bridge Endpoint](https://docs.novu.co/framework/endpoint) to a Svelte application and send our first test workflow.
...
[NestJS\\ \\ Get started with Novu Framework in a NestJS application](https://docs.novu.co/framework/quickstart/nestjs) [Nuxt\\ \\ Get started with Novu Framework in a Nuxt application](https://docs.novu.co/framework/quickstart/nuxt)
...
Copy page as markdown[Edit this page on GitHub](https://github.com/novuhq/docs/edit/main/content/docs/framework/quickstart/svelte.mdx)Open in ChatGPTOpen in Claude