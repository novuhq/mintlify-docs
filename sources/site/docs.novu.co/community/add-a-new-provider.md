...
## [How to add a new provider?](https://docs.novu.co/#how-to-add-a-new-provider)
...
## [Description](https://docs.novu.co/#description)
...
Need help installing the requirements? [Read more here](https://docs.novu.co/community/run-in-local-machine)

We have used pnpm package manager in this guide. You can use npm as well.

## [Initialization](https://docs.novu.co/#initialization)
...
## [Generate provider](https://docs.novu.co/#generate-provider)
...
### [Template test case for `example-provider`.](https://docs.novu.co/#template-test-case-for-example-provider)
...
## [Add provider logos](https://docs.novu.co/#add-provider-logos)
...
## [Add config items to the list](https://docs.novu.co/#add-config-items-to-the-list)
...
### [1\. Create credentials config](https://docs.novu.co/#1-create-credentials-config)
...
### [2\. Add ProviderId Enum](https://docs.novu.co/#2-add-providerid-enum)
...
### [3\. Add provider config to framework](https://docs.novu.co/#3-add-provider-config-to-framework)
...
packages/framework/src/schemas/providers/email/index.ts
...
### [4\. Add provider to providers list](https://docs.novu.co/#4-add-provider-to-providers-list)
...
packages/shared/src/consts/providers/channels/email.ts
...
## [Add provider handler in the API](https://docs.novu.co/#add-provider-handler-in-the-api)

### [1\. Create a provider handler](https://docs.novu.co/#1-create-a-provider-handler)
...
### [2\. Add handler to factory](https://docs.novu.co/#2-add-handler-to-factory)
...
### [Final Steps](https://docs.novu.co/#final-steps)
...
Run novu in your local machine. Read [here](https://docs.novu.co/community/run-in-local-machine) to learn on how to run novu on a local machine and test this new provider.
...
### [Reference for Adding New Providers](https://docs.novu.co/#reference-for-adding-new-providers)
...
[Run Novu in local machine\\ \\ Prerequisites and steps to run Novu in local machine. Learn how to set up Novu on your local environment for testing and development.](https://docs.novu.co/community/run-in-local-machine)

### On this page

[How to add a new provider?](https://docs.novu.co/#how-to-add-a-new-provider) [Description](https://docs.novu.co/#description) [Requirements](https://docs.novu.co/#requirements) [Initialization](https://docs.novu.co/#initialization) [Generate provider](https://docs.novu.co/#generate-provider) [Template test case for `example-provider`.](https://docs.novu.co/#template-test-case-for-example-provider) [Add provider logos](https://docs.novu.co/#add-provider-logos) [Add config items to the list](https://docs.novu.co/#add-config-items-to-the-list) [1\. Create credentials config](https://docs.novu.co/#1-create-credentials-config) [2\. Add ProviderId Enum](https://docs.novu.co/#2-add-providerid-enum) [3\. Add provider config to framework](https://docs.novu.co/#3-add-provider-config-to-framework) [4\. Add provider to providers list](https://docs.novu.co/#4-add-provider-to-providers-list) [Add provider handler in the API](https://docs.novu.co/#add-provider-handler-in-the-api) [1\. Create a provider handler](https://docs.novu.co/#1-create-a-provider-handler) [2\. Add handler to factory](https://docs.novu.co/#2-add-handler-to-factory) [Final Steps](https://docs.novu.co/#final-steps) [Reference for Adding New Providers](https://docs.novu.co/#reference-for-adding-new-providers)

Copy page as markdown[Edit this page on GitHub](https://github.com/novuhq/docs/edit/main/content/docs/community/add-a-new-provider.mdx)Open in ChatGPTOpen in Claude