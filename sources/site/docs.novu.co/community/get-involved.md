# Source: https://docs.novu.co/community/get-involved

# Get involved with the Novu Community

Your guide for engaging with the Novu Community

## [Our Community](https://docs.novu.co/#our-community)
...
## [Join the conversation](https://docs.novu.co/#join-the-conversation)
...
## [Getting help](https://docs.novu.co/#getting-help)
...
## [Contributing](https://docs.novu.co/#contributing)
...
### [Become an active community member](https://docs.novu.co/#become-an-active-community-member)
...
### [Become a power community member](https://docs.novu.co/#become-a-power-community-member)
...
### [Become a Novu Ambassador](https://docs.novu.co/#become-a-novu-ambassador)
...
## [Activities](https://docs.novu.co/#activities)

Are you passionate about notifications like we are? There are many different—and easy—ways to get involved.

### [Help in onboarding and answering questions.](https://docs.novu.co/#help-in-onboarding-and-answering-questions)
...
### [Improve our documentation](https://docs.novu.co/#improve-our-documentation)
...
### [Help with the SDKs](https://docs.novu.co/#help-with-the-sdks)
...
### [Create content](https://docs.novu.co/#create-content)
...
### [PRs, issues, and bug reports](https://docs.novu.co/#prs-issues-and-bug-reports)
...
### [Participate in office hours](https://docs.novu.co/#participate-in-office-hours)
...
[Migrate from v0 to v2 Dashboard\\ \\ A guide to help you migrate from Novu self-hosted v0 to v2](https://docs.novu.co/community/self-hosting-novu/v0-to-v2-migration) [Code of Conduct\\ \\ The set of rules and guidelines that govern interaction among community members](https://docs.novu.co/community/code-of-conduct)

### On this page

[Our Community](https://docs.novu.co/#our-community) [Join the conversation](https://docs.novu.co/#join-the-conversation) [Getting help](https://docs.novu.co/#getting-help) [Contributing](https://docs.novu.co/#contributing) [Become an active community member](https://docs.novu.co/#become-an-active-community-member) [Become a power community member](https://docs.novu.co/#become-a-power-community-member) [Become a Novu Ambassador](https://docs.novu.co/#become-a-novu-ambassador) [Activities](https://docs.novu.co/#activities) [Help in onboarding and answering questions.](https://docs.novu.co/#help-in-onboarding-and-answering-questions) [Improve our documentation](https://docs.novu.co/#improve-our-documentation) [Help with the SDKs](https://docs.novu.co/#help-with-the-sdks) [Create content](https://docs.novu.co/#create-content) [PRs, issues, and bug reports](https://docs.novu.co/#prs-issues-and-bug-reports) [Participate in office hours](https://docs.novu.co/#participate-in-office-hours)

Copy page as markdown[Edit this page on GitHub](https://github.com/novuhq/docs/edit/main/content/docs/community/get-involved.mdx)Open in ChatGPTOpen in Claude