...
## [Quick Start](https://docs.novu.co/#quick-start)
...
### [Configure Environment](https://docs.novu.co/#configure-environment)

#### [VPS Deployment](https://docs.novu.co/#vps-deployment)
...
## [Securing Your Setup](https://docs.novu.co/#securing-your-setup)
...
### [Required Variables:](https://docs.novu.co/#required-variables)
...
## [Setting Up the Inbox Component](https://docs.novu.co/#setting-up-the-inbox-component)
...
### [Install the required packages](https://docs.novu.co/#install-the-required-packages)
...
### [Configure the environment URLs](https://docs.novu.co/#configure-the-environment-urls)

Adjust the `backendUrl` and `socketUrl` based on your deployment:

### [Testing the connection](https://docs.novu.co/#testing-the-connection)
...
For more information on customizing the Inbox component, refer to the [Inbox documentation](https://docs.novu.co/inbox/overview).

## [Initializing the Node SDK](https://docs.novu.co/#initializing-the-node-sdk)
...
### [Install the package](https://docs.novu.co/#install-the-package)

```
npm install @novu/api
```

### [Initialize the SDK](https://docs.novu.co/#initialize-the-sdk)
...
### [Configure for different environments](https://docs.novu.co/#configure-for-different-environments)

Adjust the `backendUrl` based on your deployment:

### [Triggering events](https://docs.novu.co/#triggering-events)
...
For more information on using the Node SDK, refer to the [Server-Side SDKs documentation](https://docs.novu.co/sdks/overview).

### [Setting Up local studio and bridge application](https://docs.novu.co/#setting-up-local-studio-and-bridge-application)

#### [Setting Up the bridge application](https://docs.novu.co/#setting-up-the-bridge-application)
...
#### [Setting Up Novu Studio](https://docs.novu.co/#setting-up-novu-studio)
...
### [Synchronizing Workflows](https://docs.novu.co/#synchronizing-workflows)
...
### [VPS Security Considerations](https://docs.novu.co/#vps-security-considerations)
...
### [Triggering events with custom installation](https://docs.novu.co/#triggering-events-with-custom-installation)
...
### [Caching](https://docs.novu.co/#caching)
...
### [Reverse-Proxy / Load Balancers](https://docs.novu.co/#reverse-proxy--load-balancers)
...
### [Local Tunnel and Self-Hosted Deployments](https://docs.novu.co/#local-tunnel-and-self-hosted-deployments)
...
#### [When is Local Tunnel Not Required?](https://docs.novu.co/#when-is-local-tunnel-not-required)
...
#### [When is Local Tunnel Required?](https://docs.novu.co/#when-is-local-tunnel-required)
...
[Overview\\ \\ Self-host Novu for full control over your notification infrastructure. Covers system requirements, VMs, Redis, MongoDB, and storage.](https://docs.novu.co/community/self-hosting-novu/overview) [Telemetry\\ \\ Learn about Novu's telemetry data collection and how to configure it](https://docs.novu.co/community/self-hosting-novu/telemetry)

### On this page

[Prerequisites](https://docs.novu.co/#prerequisites) [Quick Start](https://docs.novu.co/#quick-start) [Configure Environment](https://docs.novu.co/#configure-environment) [VPS Deployment](https://docs.novu.co/#vps-deployment) [Securing Your Setup](https://docs.novu.co/#securing-your-setup) [Required Variables:](https://docs.novu.co/#required-variables) [Configuration](https://docs.novu.co/#configuration) [Setting Up the Inbox Component](https://docs.novu.co/#setting-up-the-inbox-component) [Install the required packages](https://docs.novu.co/#install-the-required-packages) [Create the Inbox component](https://docs.novu.co/#create-the-inbox-component) [Configure the environment URLs](https://docs.novu.co/#configure-the-environment-urls) [Testing the connection](https://docs.novu.co/#testing-the-connection) [Initializing the Node SDK](https://docs.novu.co/#initializing-the-node-sdk) [Install the package](https://docs.novu.co/#install-the-package) [Initialize the SDK](https://docs.novu.co/#initialize-the-sdk) [Configure for different environments](https://docs.novu.co/#configure-for-different-environments) [Triggering events](https://docs.novu.co/#triggering-events) [Setting Up local studio and bridge application](https://docs.novu.co/#setting-up-local-studio-and-bridge-application) [Setting Up the bridge application](https://docs.novu.co/#setting-up-the-bridge-application) [Setting Up Novu Studio](https://docs.novu.co/#setting-up-novu-studio) [Synchronizing Workflows](https://docs.novu.co/#synchronizing-workflows) [VPS Security Considerations](https://docs.novu.co/#vps-security-considerations) [Triggering events with custom installation](https://docs.novu.co/#triggering-events-with-custom-installation) [Caching](https://docs.novu.co/#caching) [Reverse-Proxy / Load Balancers](https://docs.novu.co/#reverse-proxy--load-balancers) [FAQs](https://docs.novu.co/#faqs) [Local Tunnel and Self-Hosted Deployments](https://docs.novu.co/#local-tunnel-and-self-hosted-deployments) [When is Local Tunnel Not Required?](https://docs.novu.co/#when-is-local-tunnel-not-required) [When is Local Tunnel Required?](https://docs.novu.co/#when-is-local-tunnel-required)

Copy page as markdown[Edit this page on GitHub](https://github.com/novuhq/docs/edit/main/content/docs/community/self-hosting-novu/deploy-with-docker.mdx)Open in ChatGPTOpen in Claude