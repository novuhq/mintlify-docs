# Source: https://docs.novu.co/community/code-of-conduct
...
## [Being considerate and using appropriate channels](https://docs.novu.co/#being-considerate-and-using-appropriate-channels)
...
## [Adhering to these standards](https://docs.novu.co/#adhering-to-these-standards)
...
## [Patience](https://docs.novu.co/#patience)
...
## [Inclusivity, kindness and respectfulness](https://docs.novu.co/#inclusivity-kindness-and-respectfulness)
...
## [Inquisitive](https://docs.novu.co/#inquisitive)
...
## [Helpful](https://docs.novu.co/#helpful)
...
## [Anti-harassment policy](https://docs.novu.co/#anti-harassment-policy)
...
## [Reporting policy violations](https://docs.novu.co/#reporting-policy-violations)
...
## [Enforcement Guidelines](https://docs.novu.co/#enforcement-guidelines)
...
[Get Involved\\ \\ Your guide for engaging with the Novu Community](https://docs.novu.co/community/get-involved) [Roadmap\\ \\ Learn about our roadmap](https://docs.novu.co/community/roadmap)

### On this page

[Being considerate and using appropriate channels](https://docs.novu.co/#being-considerate-and-using-appropriate-channels) [Adhering to these standards](https://docs.novu.co/#adhering-to-these-standards) [Patience](https://docs.novu.co/#patience) [Inclusivity, kindness and respectfulness](https://docs.novu.co/#inclusivity-kindness-and-respectfulness) [Inquisitive](https://docs.novu.co/#inquisitive) [Helpful](https://docs.novu.co/#helpful) [Anti-harassment policy](https://docs.novu.co/#anti-harassment-policy) [Reporting policy violations](https://docs.novu.co/#reporting-policy-violations) [Enforcement Guidelines](https://docs.novu.co/#enforcement-guidelines)

Copy page as markdown[Edit this page on GitHub](https://github.com/novuhq/docs/edit/main/content/docs/community/code-of-conduct.mdx)Open in ChatGPTOpen in Claude