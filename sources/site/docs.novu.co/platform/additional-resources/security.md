# Source: https://docs.novu.co/platform/additional-resources/security

# Security and Compliance

Learn about Novu security certifications, compliance standards, data residency, and privacy policies

## [How to Request SOC and ISO Reports](https://docs.novu.co/#how-to-request-soc-and-iso-reports)
...
## [Compliance Certifications](https://docs.novu.co/#compliance-certifications)

### [SOC 2 Type II](https://docs.novu.co/#soc-2-type-ii)
...
### [ISO 27001](https://docs.novu.co/#iso-27001)
...
### [HIPAA](https://docs.novu.co/#hipaa)
...
## [Data Residency](https://docs.novu.co/#data-residency)

### [Available Regions](https://docs.novu.co/#available-regions)
...
### [Switching Regions](https://docs.novu.co/#switching-regions)
...
### [Self-Hosted and Hybrid Options](https://docs.novu.co/#self-hosted-and-hybrid-options)
...
## [Data Storage and Retention](https://docs.novu.co/#data-storage-and-retention)
...
## [Regulatory and PII Concerns](https://docs.novu.co/#regulatory-and-pii-concerns)
...
## [Reporting Security Vulnerabilities](https://docs.novu.co/#reporting-security-vulnerabilities)
...
[Common errors\\ \\ Understand common errors in your notification workflows and how to resolve them](https://docs.novu.co/platform/additional-resources/errors) [v0.x Documentation\\ \\ Access the legacy v0.x Novu documentation for older versions of the platform.](https://docs.novu.co/platform/additional-resources/legacy-documentation)

### On this page

[How to Request SOC and ISO Reports](https://docs.novu.co/#how-to-request-soc-and-iso-reports) [Compliance Certifications](https://docs.novu.co/#compliance-certifications) [SOC 2 Type II](https://docs.novu.co/#soc-2-type-ii) [ISO 27001](https://docs.novu.co/#iso-27001) [HIPAA](https://docs.novu.co/#hipaa) [GDPR](https://docs.novu.co/#gdpr) [Data Residency](https://docs.novu.co/#data-residency) [Available Regions](https://docs.novu.co/#available-regions) [Switching Regions](https://docs.novu.co/#switching-regions) [Self-Hosted and Hybrid Options](https://docs.novu.co/#self-hosted-and-hybrid-options) [Data Storage and Retention](https://docs.novu.co/#data-storage-and-retention) [Regulatory and PII Concerns](https://docs.novu.co/#regulatory-and-pii-concerns) [Reporting Security Vulnerabilities](https://docs.novu.co/#reporting-security-vulnerabilities)

Copy page as markdown[Edit this page on GitHub](https://github.com/novuhq/docs/edit/main/content/docs/platform/additional-resources/security.mdx)Open in ChatGPTOpen in Claude