# Source: https://docs.novu.co/platform/additional-resources/glossary

# Novu Glossary

Definitions

## [Introduction](https://docs.novu.co/#introduction)
...
## [List of key terms and definitions](https://docs.novu.co/#list-of-key-terms-and-definitions)
...
The agent brain is the system that decides how an agent responds. It can be powered by an LLM, custom code, a rules engine, a human-in-the-loop workflow, a managed agent platform, or a combination of systems. The agent brain is separate from the communication infrastructure that delivers messages across channels, which is handled by [ACI](https://docs.novu.co/agents/get-started/what-is-aci).

### [Channels](https://docs.novu.co/#channels)
...
### [Layouts](https://docs.novu.co/#layouts)
...
### [Organizations](https://docs.novu.co/#organizations)
...
### [Team members](https://docs.novu.co/#team-members)
...
### [Topics](https://docs.novu.co/#topics)
...
[Agent Toolkit\\ \\ Expose Novu notification workflows as tools for LLM agents with the @novu/agent-toolkit package. Works with OpenAI, LangChain, and Vercel AI SDK.](https://docs.novu.co/platform/build-with-ai/agent-toolkit) [Common errors\\ \\ Understand common errors in your notification workflows and how to resolve them](https://docs.novu.co/platform/additional-resources/errors)

### On this page

[Introduction](https://docs.novu.co/#introduction) [List of key terms and definitions](https://docs.novu.co/#list-of-key-terms-and-definitions) [Actor](https://docs.novu.co/#actor) [Agent brain](https://docs.novu.co/#agent-brain) [Channels](https://docs.novu.co/#channels) [Delay Actions](https://docs.novu.co/#delay-actions) [Digest Engine](https://docs.novu.co/#digest-engine) [Environments](https://docs.novu.co/#environments) [Layouts](https://docs.novu.co/#layouts) [Notification](https://docs.novu.co/#notification) [Organizations](https://docs.novu.co/#organizations) [Providers](https://docs.novu.co/#providers) [Step Filter](https://docs.novu.co/#step-filter) [Subscribers](https://docs.novu.co/#subscribers) [Team members](https://docs.novu.co/#team-members) [Topics](https://docs.novu.co/#topics) [Workflow](https://docs.novu.co/#workflow)

Copy page as markdown[Edit this page on GitHub](https://github.com/novuhq/docs/edit/main/content/docs/platform/additional-resources/glossary.mdx)Open in ChatGPTOpen in Claude