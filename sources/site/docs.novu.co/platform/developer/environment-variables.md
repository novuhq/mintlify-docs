# Source: https://docs.novu.co/platform/developer/environment-variables
...
Environment variables in Novu are named values you define once in the dashboard and reuse across workflows. Each [Novu environment](https://docs.novu.co/platform/developer/environments) can hold its own value for the same variable, so Development and Production (and any custom environments) stay isolated without duplicating workflow logic.
...
## [What you can do](https://docs.novu.co/#what-you-can-do)
...
## [Create and manage variables](https://docs.novu.co/#create-and-manage-variables)
...
![Create and manage variables](https://docs.novu.co/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fcreate-a-variable.01a6391d.gif&w=3840&q=75)
...
### [Values per environment](https://docs.novu.co/#values-per-environment)
...
## [Reference variables in workflows](https://docs.novu.co/#reference-variables-in-workflows)
...
![Using variables in workflows](https://docs.novu.co/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fusing-variable-in-email.3dfcab26.gif&w=3840&q=75)
...
- [Environments](https://docs.novu.co/platform/developer/environments) for how Development, Production, and custom environments differ.
- [Personalize content](https://docs.novu.co/platform/workflow/add-notification-content/personalize-content) for more on Liquid and template variables beyond `env`.

[Environments\\ \\ Understanding and managing environments in Novu](https://docs.novu.co/platform/developer/environments) [Limits\\ \\ System limits, quotas, and constraints for the Novu platform.](https://docs.novu.co/platform/developer/limits)

### On this page

[What you can do](https://docs.novu.co/#what-you-can-do) [Create and manage variables](https://docs.novu.co/#create-and-manage-variables) [Values per environment](https://docs.novu.co/#values-per-environment) [Reference variables in workflows](https://docs.novu.co/#reference-variables-in-workflows) [Use cases](https://docs.novu.co/#use-cases) [Related documentation](https://docs.novu.co/#related-documentation)

Copy page as markdown[Edit this page on GitHub](https://github.com/novuhq/docs/edit/main/content/docs/platform/developer/environment-variables.mdx)Open in ChatGPTOpen in Claude