# Source: https://docs.novu.co/platform/developer/webhooks/connectors
...
## [How to add a connector endpoint](https://docs.novu.co/#how-to-add-a-connector-endpoint)

1. Go to the **[Webhooks](https://dashboard.novu.co/webhooks)** page in the Novu dashboard.
2. Select the **Endpoints** tab.
3. Click **Add Endpoint**.
4. Search for or select the connector you want to use from the integrations list. ![Webhook integrations list](https://docs.novu.co/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fwebhook-integrations.78c2eaac.png&w=3840&q=75)
...
7. For **data warehouse connectors** (ClickHouse, Snowflake, Redshift): define the **table schema** and write a **transformation** that maps Novu webhook payloads to rows matching that schema. See [Data warehouse connectors](https://docs.novu.co/#data-warehouse-connectors).
8. For **message connectors** (Amazon SQS, Amazon SNS): review and customize the **transformation** that shapes the message body sent to the queue or topic. See [Message connectors](https://docs.novu.co/#message-connectors).
9. Select the [event types](https://docs.novu.co/platform/developer/webhooks/event-types) you want this endpoint to subscribe to.
10. Click **Create**.
...
## [Available connectors](https://docs.novu.co/#available-connectors)

Novu supports the following webhook connectors:

| Connector | Type | Description |
| --- | --- | --- |
| [ClickHouse](https://docs.novu.co/#clickhouse) | Data warehouse | Store events in a ClickHouse table. |
| [Snowflake](https://docs.novu.co/#snowflake) | Data warehouse | Store events in a Snowflake table. |
| [Amazon Redshift](https://docs.novu.co/#amazon-redshift) | Data warehouse | Store events in an Amazon Redshift table. |
| [Amazon SQS](https://docs.novu.co/#amazon-sqs) | Message | Send events to an Amazon SQS queue. |
| [Amazon SNS](https://docs.novu.co/#amazon-sns) | Message | Send events to an Amazon SNS topic. |
...
## [Transformations](https://docs.novu.co/#transformations)
...
### [How to write a transformation](https://docs.novu.co/#how-to-write-a-transformation)
...
| `webhook.payload` | The webhook JSON body. Shape depends on the event type—see [event types](https://docs.novu.co/platform/developer/webhooks/event-types). |
...
Handle every [event type](https://docs.novu.co/platform/developer/webhooks/event-types) your endpoint subscribes to. Use `switch (webhook.eventType)` or equivalent logic so each event maps to a valid destination record.

## [Data warehouse connectors](https://docs.novu.co/#data-warehouse-connectors)
...
### [Recommended setup flow](https://docs.novu.co/#recommended-setup-flow)
...
### [Example transformation](https://docs.novu.co/#example-transformation)
...
## [Message connectors](https://docs.novu.co/#message-connectors)
...
## [ClickHouse](https://docs.novu.co/#clickhouse)
...
### [Configuration](https://docs.novu.co/#configuration)
...
## [Snowflake](https://docs.novu.co/#snowflake)
...
### [Configuration](https://docs.novu.co/#configuration-1)
...
### [Setup](https://docs.novu.co/#setup-1)
...
## [Amazon Redshift](https://docs.novu.co/#amazon-redshift)
...
### [Configuration](https://docs.novu.co/#configuration-2)
...
### [Setup](https://docs.novu.co/#setup-2)
...
## [Amazon SQS](https://docs.novu.co/#amazon-sqs)
...
### [Configuration](https://docs.novu.co/#configuration-3)
...
### [Setup](https://docs.novu.co/#setup-3)
...
## [Amazon SNS](https://docs.novu.co/#amazon-sns)
...
### [Configuration](https://docs.novu.co/#configuration-4)
...
### [Setup](https://docs.novu.co/#setup-4)
...
## [Monitoring and troubleshooting](https://docs.novu.co/#monitoring-and-troubleshooting)
...
| Unhandled event types | Transformation includes a branch for every subscribed [event type](https://docs.novu.co/platform/developer/webhooks/event-types). |

If the destination service is unreachable from Novu's webhook infrastructure, deliveries will continue to retry according to the [retry schedule](https://docs.novu.co/platform/developer/webhooks#recovery-and-resending-failed-messages) before the endpoint is disabled.

[Event types\\ \\ Learn more about the types of events that Novu sends webhook events for.](https://docs.novu.co/platform/developer/webhooks/event-types) [Authentication\\ \\ Configure authentication for Novu with OAuth, SSO, MFA, and more. Available for Enterprise customers on Novu Cloud.](https://docs.novu.co/platform/account/authentication)

### On this page

[How to add a connector endpoint](https://docs.novu.co/#how-to-add-a-connector-endpoint) [Available connectors](https://docs.novu.co/#available-connectors) [Transformations](https://docs.novu.co/#transformations) [How to write a transformation](https://docs.novu.co/#how-to-write-a-transformation) [Data warehouse connectors](https://docs.novu.co/#data-warehouse-connectors) [Recommended setup flow](https://docs.novu.co/#recommended-setup-flow) [Example transformation](https://docs.novu.co/#example-transformation) [Message connectors](https://docs.novu.co/#message-connectors) [ClickHouse](https://docs.novu.co/#clickhouse) [Configuration](https://docs.novu.co/#configuration) [Setup](https://docs.novu.co/#setup) [Snowflake](https://docs.novu.co/#snowflake) [Configuration](https://docs.novu.co/#configuration-1) [Setup](https://docs.novu.co/#setup-1) [Amazon Redshift](https://docs.novu.co/#amazon-redshift) [Configuration](https://docs.novu.co/#configuration-2) [Setup](https://docs.novu.co/#setup-2) [Amazon SQS](https://docs.novu.co/#amazon-sqs) [Configuration](https://docs.novu.co/#configuration-3) [Setup](https://docs.novu.co/#setup-3) [Amazon SNS](https://docs.novu.co/#amazon-sns) [Configuration](https://docs.novu.co/#configuration-4) [Setup](https://docs.novu.co/#setup-4) [Monitoring and troubleshooting](https://docs.novu.co/#monitoring-and-troubleshooting)

Copy page as markdown[Edit this page on GitHub](https://github.com/novuhq/docs/edit/main/content/docs/platform/developer/webhooks/connectors.mdx)Open in ChatGPTOpen in Claude