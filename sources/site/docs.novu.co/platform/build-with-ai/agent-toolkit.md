...
## [What is the Agent Toolkit?](https://docs.novu.co/#what-is-the-agent-toolkit)
...
The Agent Toolkit is a code-level SDK for embedding Novu tools inside your own AI agents. For giving AI coding assistants (Claude Code, Cursor, Copilot) context about Novu, see [Agent Skills](https://docs.novu.co/platform/build-with-ai/skills). For connecting AI tools to Novu via the Model Context Protocol, see [MCP](https://docs.novu.co/platform/build-with-ai/mcp).
...
### [LangChain](https://docs.novu.co/#langchain)
...
### [Vercel AI SDK](https://docs.novu.co/#vercel-ai-sdk)
...
### [`trigger_workflow`](https://docs.novu.co/#trigger_workflow)
...
### [`update_preferences`](https://docs.novu.co/#update_preferences)
...
## [Dynamic Workflow Tools](https://docs.novu.co/#dynamic-workflow-tools)
...
## [Source Code](https://docs.novu.co/#source-code)
...
### [Package Structure](https://docs.novu.co/#package-structure)
...
### [Available Exports](https://docs.novu.co/#available-exports)
...
[Agent Skills\\ \\ Learn how to use Novu Agent Skills to help AI agents build multi-channel notification systems.](https://docs.novu.co/platform/build-with-ai/skills) [Glossary\\ \\ Definitions](https://docs.novu.co/platform/additional-resources/glossary)

### On this page

[What is the Agent Toolkit?](https://docs.novu.co/#what-is-the-agent-toolkit) [Installation](https://docs.novu.co/#installation) [Quick Start](https://docs.novu.co/#quick-start) [Configuration](https://docs.novu.co/#configuration) [Framework Adapters](https://docs.novu.co/#framework-adapters) [OpenAI](https://docs.novu.co/#openai) [LangChain](https://docs.novu.co/#langchain) [Vercel AI SDK](https://docs.novu.co/#vercel-ai-sdk) [Built-in Tools](https://docs.novu.co/#built-in-tools) [`trigger_workflow`](https://docs.novu.co/#trigger_workflow) [`update_preferences`](https://docs.novu.co/#update_preferences) [Dynamic Workflow Tools](https://docs.novu.co/#dynamic-workflow-tools) [Use Cases](https://docs.novu.co/#use-cases) [Source Code](https://docs.novu.co/#source-code) [Package Structure](https://docs.novu.co/#package-structure) [Available Exports](https://docs.novu.co/#available-exports)

Copy page as markdown[Edit this page on GitHub](https://github.com/novuhq/docs/edit/main/content/docs/platform/build-with-ai/agent-toolkit.mdx)Open in ChatGPTOpen in Claude