# Source: https://docs.novu.co/platform/concepts/trigger
...
## [Trigger Request](https://docs.novu.co/#trigger-request)
...
## [Trigger Endpoint](https://docs.novu.co/#trigger-endpoint)

Upon sending the request to the [event/trigger](https://docs.novu.co/api-reference/events/trigger-event) endpoint, a series of essential steps are initiated:
...
## [Trigger Event Processing](https://docs.novu.co/#trigger-event-processing)
...
### [What is an event?](https://docs.novu.co/#what-is-an-event)

An event is a request (for instance, an API call to [/v1/events/trigger](https://docs.novu.co/api-reference/events/trigger-event)) that starts off an action in the Novu Workflow Engine. Events can make many different types of actions, including digests, delays, and sending notifications to various channels, as well as filters and user preference checks.

### [How events are billed?](https://docs.novu.co/#how-events-are-billed)

If a workflow is triggered to a [subscriber](https://docs.novu.co/platform/concepts/subscribers), then it is billed as 1 event. So if workflow is triggered to group of 15 subscribers, then it is billed as 15 events. Similary, if a workflow is triggered to a [topic](https://docs.novu.co/platform/concepts/topics), Novu creates one event per topic subscriber, this means that a workflow trigger to a topic with 100 subscribers creates 100 events.

### [If notifications were filtered out, are they still billed?](https://docs.novu.co/#if-notifications-were-filtered-out-are-they-still-billed)

Yes, they are still billed. The number of billed events is the number of subscribers or topic subscribers the workflow was triggered to, regardless of whether notifications were filtered out as per subscriber's [workflow channel preferences](https://docs.novu.co/platform/concepts/preferences#workflow-channel-preferences), [global channel preferences](https://docs.novu.co/platform/concepts/preferences#subscriber-global-preferences) or [step conditions](https://docs.novu.co/platform/workflow/add-and-configure-steps/step-conditions).

### [How events are billed for digested events?](https://docs.novu.co/#how-events-are-billed-for-digested-events)
...
[Integrations\\ \\ Learn how Novu integrations connect you to third-party providers](https://docs.novu.co/platform/concepts/integrations) [Preferences\\ \\ Learn how to manage subscriber preferences in Novu.](https://docs.novu.co/platform/concepts/preferences)

### On this page

[Trigger Request](https://docs.novu.co/#trigger-request) [Trigger Endpoint](https://docs.novu.co/#trigger-endpoint) [Trigger Event Processing](https://docs.novu.co/#trigger-event-processing) [Jobs](https://docs.novu.co/#jobs) [Job Statuses](https://docs.novu.co/#job-statuses) [Frequently asked questions](https://docs.novu.co/#frequently-asked-questions) [What is an event?](https://docs.novu.co/#what-is-an-event) [How events are billed?](https://docs.novu.co/#how-events-are-billed) [If notifications were filtered out, are they still billed?](https://docs.novu.co/#if-notifications-were-filtered-out-are-they-still-billed) [How events are billed for digested events?](https://docs.novu.co/#how-events-are-billed-for-digested-events)

Copy page as markdown[Edit this page on GitHub](https://github.com/novuhq/docs/edit/main/content/docs/platform/concepts/trigger.mdx)Open in ChatGPTOpen in Claude