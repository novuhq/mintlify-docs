# Source: https://docs.novu.co/platform/concepts/workflows
...
## [Workflow steps](https://docs.novu.co/#workflow-steps)
...
### [Types of steps](https://docs.novu.co/#types-of-steps)
...
### [Designing multi-channel sequences](https://docs.novu.co/#designing-multi-channel-sequences)
...
## [Workflows editor](https://docs.novu.co/#workflows-editor)
...
While most users rely on the Shared Bridge Endpoint, Novu allows advanced users to host their own Bridge application and define workflows in code using the [Novu Framework](https://docs.novu.co/framework).

To learn more about building workflows using the workflow editor, filters, and personalizing templates, refer to the [Building Workflows documentation](https://docs.novu.co/platform/workflow).

## [Workflow identifier](https://docs.novu.co/#workflow-identifier)
...
## [Workflow tags](https://docs.novu.co/#workflow-tags)
...
### [Example use cases:](https://docs.novu.co/#example-use-cases)
...
## [Syncing workflows between environments](https://docs.novu.co/#syncing-workflows-between-environments)
...
### [When a workflow is synced:](https://docs.novu.co/#when-a-workflow-is-synced)
...
### [Syncing is supported across environments based on your plan:](https://docs.novu.co/#syncing-is-supported-across-environments-based-on-your-plan)
...
To learn more about triggering workflows via API, handling payloads, and understanding the request lifecycle, refer to [Triggering Workflows](https://docs.novu.co/platform/concepts/trigger).

## [Workflow activity feed](https://docs.novu.co/#workflow-activity-feed)
...
These defaults ensure that subscribers receive messages through the most appropriate channels, even if they haven’t customized their own preferences. To learn more about channel preferences, refer to [preferences](https://docs.novu.co/platform/concepts/preferences).

## [Workflow step conditions](https://docs.novu.co/#workflow-step-conditions)
...
To learn more about all supported condition types, operators, and usage example, refer to the [Step Conditions documentation](https://docs.novu.co/platform/workflow/add-and-configure-steps/step-conditions).
...
### [Do I have to create a workflow to send notifications?](https://docs.novu.co/#do-i-have-to-create-a-workflow-to-send-notifications)

Yes, creating a workflow is mandatory to send notifications.

### [Can workflows be created and managed via code?](https://docs.novu.co/#can-workflows-be-created-and-managed-via-code)

Yes, workflows can be managed via code, if you are using Node.js, you can use the [Novu Framework](https://docs.novu.co/framework/introduction)

### [Can all workflows be synced at once to another environment?](https://docs.novu.co/#can-all-workflows-be-synced-at-once-to-another-environment)

Currently, only a single workflow can be synced at a time.

[How Novu Works\\ \\ A high-level overview of Novu’s architecture: workflows, triggers, subscribers, and environments, and how they connect to support in-app and external channels.](https://docs.novu.co/platform/how-novu-works) [Subscribers\\ \\ Learn what a subscriber is in Novu, how they’re identified, and how they fit into the notification system.](https://docs.novu.co/platform/concepts/subscribers)

### On this page

[Workflow steps](https://docs.novu.co/#workflow-steps) [Types of steps](https://docs.novu.co/#types-of-steps) [Channel steps](https://docs.novu.co/#channel-steps) [Action steps](https://docs.novu.co/#action-steps) [Designing multi-channel sequences](https://docs.novu.co/#designing-multi-channel-sequences) [Workflows editor](https://docs.novu.co/#workflows-editor) [Workflow identifier](https://docs.novu.co/#workflow-identifier) [Workflow status](https://docs.novu.co/#workflow-status) [Workflow tags](https://docs.novu.co/#workflow-tags) [Example use cases:](https://docs.novu.co/#example-use-cases) [Critical workflows](https://docs.novu.co/#critical-workflows) [Syncing workflows between environments](https://docs.novu.co/#syncing-workflows-between-environments) [When a workflow is synced:](https://docs.novu.co/#when-a-workflow-is-synced) [Syncing is supported across environments based on your plan:](https://docs.novu.co/#syncing-is-supported-across-environments-based-on-your-plan) [Triggering workflows](https://docs.novu.co/#triggering-workflows) [Workflow activity feed](https://docs.novu.co/#workflow-activity-feed) [Workflow channel preferences](https://docs.novu.co/#workflow-channel-preferences) [Workflow step conditions](https://docs.novu.co/#workflow-step-conditions) [Frequently asked questions](https://docs.novu.co/#frequently-asked-questions) [Do I have to create a workflow to send notifications?](https://docs.novu.co/#do-i-have-to-create-a-workflow-to-send-notifications) [Can workflows be created and managed via code?](https://docs.novu.co/#can-workflows-be-created-and-managed-via-code) [Can all workflows be synced at once to another environment?](https://docs.novu.co/#can-all-workflows-be-synced-at-once-to-another-environment)

Copy page as markdown[Edit this page on GitHub](https://github.com/novuhq/docs/edit/main/content/docs/platform/concepts/workflows.mdx)Open in ChatGPTOpen in Claude