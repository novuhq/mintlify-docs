# Source: https://docs.novu.co/platform/workflow/add-notification-content/personalize-content
...
## [Template variables](https://docs.novu.co/#template-variables)
...
You can [configure all template variables](https://docs.novu.co/platform/workflow/add-notification-content/personalize-content#configure-variables) from the template editor to fit your use case.

### [Payload variables](https://docs.novu.co/#payload-variables)
...
To learn how payload data is defined and validated, see the [Payload schema](https://docs.novu.co/platform/workflow/configure-workflow#payload-schema) documentation.

### [Subscriber variables](https://docs.novu.co/#subscriber-variables)
...
To learn more about subscriber metadata and profile structure, refer to the [Subscriber documentation](https://docs.novu.co/platform/concepts/subscribers#subscriber-metadata-and-profile-structure).

### [Workflow variables](https://docs.novu.co/#workflow-variables)
...
To learn how to create and manage environment variables, refer to [Environment variables](https://docs.novu.co/platform/developer/environment-variables).

### [Digest variables](https://docs.novu.co/#digest-variables)
...
#### [Digest step variables](https://docs.novu.co/#digest-step-variables)
...
#### [Digest template helpers](https://docs.novu.co/#digest-template-helpers)
...
### [Context variables](https://docs.novu.co/#context-variables)
...
To learn how to create and manage context data, and how to use the context data in the template editor, refer to [Context](https://docs.novu.co/platform/workflow/advanced-features/contexts).

## [Apply logic with LiquidJS](https://docs.novu.co/#apply-logic-with-liquidjs)
...
### [Conditional rendering](https://docs.novu.co/#conditional-rendering)
...
### [Iteration and loops](https://docs.novu.co/#iteration-and-loops)
...
### [Filters and transformations](https://docs.novu.co/#filters-and-transformations)
...
## [Configure variables](https://docs.novu.co/#configure-variables)
...
![Configure variable](https://docs.novu.co/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fconfigure-variable.df2aef00.png&w=3840&q=75)

When you insert a variable into the template editor, click the variable to open the configuration menu.

![Configure variable](https://docs.novu.co/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fconfigure-variable.6f9a17ee.gif&w=3840&q=75)
...
[Channels Template Editors\\ \\ Learn how to design and configure notification content for email, in-app, push, and SMS.](https://docs.novu.co/platform/workflow/add-notification-content/channels-template-editors) [Trigger Workflow\\ \\ Learn how workflows are triggered in Novu using the Event API, including triggering workflows for individual subscribers, attaching context data, and broadcasting notifications to topics.](https://docs.novu.co/platform/workflow/trigger-workflow)

### On this page

[Template variables](https://docs.novu.co/#template-variables) [Payload variables](https://docs.novu.co/#payload-variables) [Subscriber variables](https://docs.novu.co/#subscriber-variables) [Workflow variables](https://docs.novu.co/#workflow-variables) [Environment variables](https://docs.novu.co/#environment-variables) [Digest variables](https://docs.novu.co/#digest-variables) [Digest step variables](https://docs.novu.co/#digest-step-variables) [Digest template helpers](https://docs.novu.co/#digest-template-helpers) [Context variables](https://docs.novu.co/#context-variables) [Apply logic with LiquidJS](https://docs.novu.co/#apply-logic-with-liquidjs) [Conditional rendering](https://docs.novu.co/#conditional-rendering) [Iteration and loops](https://docs.novu.co/#iteration-and-loops) [Filters and transformations](https://docs.novu.co/#filters-and-transformations) [Configure variables](https://docs.novu.co/#configure-variables)

Copy page as markdown[Edit this page on GitHub](https://github.com/novuhq/docs/edit/main/content/docs/platform/workflow/add-notification-content/personalize-content.mdx)Open in ChatGPTOpen in Claude