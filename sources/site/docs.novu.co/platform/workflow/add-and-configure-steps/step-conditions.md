# Source: https://docs.novu.co/platform/workflow/add-and-configure-steps/step-conditions
...
## [Add step conditions](https://docs.novu.co/#add-step-conditions)

You configure step conditions from the Workflow Editor.

1. Select a step in the Workflow Editor.
2. In the **Configure** step panel, click **Step Conditions**. ![Step conditions](https://docs.novu.co/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fstep-conditions.0cb4fd48.png&w=3840&q=75)
3. Proceed to add your step conditions.

![Step conditions](https://docs.novu.co/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fstep-conditions.86d7b0c2.gif&w=3840&q=75)

If the condition evaluates to `true`, the step runs. If it evaluates to `false`, the step is skipped and the workflow continues.

## [How the condition builder works](https://docs.novu.co/#how-the-condition-builder-works)
...
## [Supported operators](https://docs.novu.co/#supported-operators)
...
## [Data used for step conditions](https://docs.novu.co/#data-used-for-step-conditions)
...
### [Subscriber data](https://docs.novu.co/#subscriber-data)
...
To learn more about Subscribers model, refer to the [Subscribers documentation](https://docs.novu.co/platform/concepts/subscribers)

### [Payload data](https://docs.novu.co/#payload-data)

You can use data from the [payload schema](https://docs.novu.co/platform/workflow/configure-workflow#payload-schema) or custom payload data passed during the workflow trigger call to the Novu API to configure step conditions. This allows you to define dynamic rules based on the data unique to each workflow execution.
...
![Workflow step conditions](https://docs.novu.co/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fworkflow-step-conditions.030232d1.png&w=3840&q=75)
...
### [Previous step result](https://docs.novu.co/#previous-step-result)
...
### [Context](https://docs.novu.co/#context)
...
To learn more about context, refer to the [Context documentation](https://docs.novu.co/platform/workflow/advanced-features/contexts).

### [Dynamic data fields](https://docs.novu.co/#dynamic-data-fields)
...
For more complex scenarios where you need to perform advanced calculations based on your application state, you can use the [Novu Framework](https://docs.novu.co/framework/typescript/steps).

[HTTP Step\\ \\ Learn how to use HTTP step to make external HTTP requests.](https://docs.novu.co/platform/workflow/add-and-configure-steps/configure-action-steps/http-step) [Code Steps\\ \\ Learn how to add code steps to a workflow, publish them with the Novu CLI, and use code-managed steps with UI-managed steps in a workflow.](https://docs.novu.co/platform/workflow/add-and-configure-steps/code-steps)

### On this page

[Add step conditions](https://docs.novu.co/#add-step-conditions) [How the condition builder works](https://docs.novu.co/#how-the-condition-builder-works) [Supported operators](https://docs.novu.co/#supported-operators) [Data used for step conditions](https://docs.novu.co/#data-used-for-step-conditions) [Subscriber data](https://docs.novu.co/#subscriber-data) [Payload data](https://docs.novu.co/#payload-data) [Workflow variables](https://docs.novu.co/#workflow-variables) [Previous step result](https://docs.novu.co/#previous-step-result) [Context](https://docs.novu.co/#context) [Dynamic data fields](https://docs.novu.co/#dynamic-data-fields)

Copy page as markdown[Edit this page on GitHub](https://github.com/novuhq/docs/edit/main/content/docs/platform/workflow/add-and-configure-steps/step-conditions.mdx)Open in ChatGPTOpen in Claude