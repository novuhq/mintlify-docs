# Source: https://docs.novu.co/platform/sdks/react/changelog

@novu/react

# Novu React SDK Changelog
...
- **root:** add NEW\_RELIC\_ENABLED to docker community ([#7943](https://github.com/novuhq/novu/pull/7943))
...
- **application-generic:** add SUBSCRIBER\_WIDGET\_JWT\_EXPIRATION\_TIME env variable ([#7105](https://github.com/novuhq/novu/pull/7105))
...
[useSchedule\\ \\ Learn how to use the useSchedule hook to manage subscriber notification schedules in your React application](https://docs.novu.co/platform/sdks/react/hooks/use-schedule) [@novu/js\\ \\ Complete API reference for the Novu JavaScript package](https://docs.novu.co/platform/sdks/javascript)

### On this page

No Headings

Copy page as markdown[Edit this page on GitHub](https://github.com/novuhq/docs/edit/main/content/docs/platform/sdks/react/changelog.mdx)Open in ChatGPTOpen in Claude