# Source: https://docs.novu.co/platform/account/roles-and-permissions

# Roles and permissions

Learn how roles and permissions are managed within Novu organizations

Novu uses a role-based access control (RBAC) model at the [organization level](https://docs.novu.co/platform/how-novu-works#organization-and-environments). Each member in the organization is assigned a role that determines the actions they can perform within the Novu dashboard. Every user can belong to more than one organization, each with separate configurations and permissions.
...
## [Roles and permissions table](https://docs.novu.co/#roles-and-permissions-table)
...
[Authentication\\ \\ Configure authentication for Novu with OAuth, SSO, MFA, and more. Available for Enterprise customers on Novu Cloud.](https://docs.novu.co/platform/account/authentication) [Team members\\ \\ How to invite, manage, update permissions for, and remove members from your Novu organization](https://docs.novu.co/platform/account/manage-members)

### On this page

[Roles and permissions table](https://docs.novu.co/#roles-and-permissions-table)

Copy page as markdown[Edit this page on GitHub](https://github.com/novuhq/docs/edit/main/content/docs/platform/account/roles-and-permissions.mdx)Open in ChatGPTOpen in Claude