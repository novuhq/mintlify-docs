# Source: https://docs.novu.co/platform/inbox/configuration/icons
...
## [List of customizable icons](https://docs.novu.co/#list-of-customizable-icons)
...
[Inbox with Context\\ \\ Learn how to use contexts in the Inbox component to filter and personalize notifications for your subscribers.](https://docs.novu.co/platform/inbox/configuration/inbox-with-context) [Customize Bell Icon\\ \\ Learn how to fully customize the inbox component bell icon using your own components or third-party libraries.](https://docs.novu.co/platform/inbox/advanced-customization/customize-bell)

### On this page

[List of customizable icons](https://docs.novu.co/#list-of-customizable-icons)

Copy page as markdown[Edit this page on GitHub](https://github.com/novuhq/docs/edit/main/content/docs/platform/inbox/configuration/icons.mdx)Open in ChatGPTOpen in Claude