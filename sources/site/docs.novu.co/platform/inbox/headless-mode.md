...
Build a fully custom notification inbox with Novu's headless React hooks without being constrained by the default [<Inbox />](https://docs.novu.co/platform/inbox) UI or dependencies.

The [**`@novu/react`**](https://docs.novu.co/platform/sdks/react) package provides a set of hooks, such as `useNotifications` and `useCounts`. You handle the layout, styling, and interactions, while Novu provides the notification state, real-time updates, and actions.

Not using React? You can access the same data manually using the [JavaScript SDK](https://docs.novu.co/platform/sdks/javascript).

## [Install the React SDK package](https://docs.novu.co/#install-the-react-sdk-package)
...
## [Add the `NovuProvider`](https://docs.novu.co/#add-the-novuprovider)

Wrap your application or the components that need access to notifications with the `NovuProvider`. This component initializes the Novu client and provides it to all child hooks via [context](https://docs.novu.co/platform/workflow/advanced-features/contexts).
...
For more `NovuProvider` options, such as HMAC encryption, see the [Novu provider documentation](https://docs.novu.co/platform/sdks/react/hooks/novu-provider).

## [Fetch and display notifications](https://docs.novu.co/#fetch-and-display-notifications)
...
## [Show notification counts](https://docs.novu.co/#show-notification-counts)
...
## [Adding notification actions](https://docs.novu.co/#adding-notification-actions)
...
## [Showing product updates banner](https://docs.novu.co/#showing-product-updates-banner)
...
8. As per product release requirements, [Permanently delete](https://docs.novu.co/api-reference/messages/delete-a-message) or [archive](https://docs.novu.co/platform/sdks/javascript#archive) the product update notification to hide the banner.
...
## [Real-time updates](https://docs.novu.co/#real-time-updates)
...
### [Using websocket events](https://docs.novu.co/#using-websocket-events)
...
[Multi-tenancy\\ \\ Learn how to use context to implement multi-tenant notifications to support different organizations or workspaces within your application.](https://docs.novu.co/platform/inbox/advanced-features/multi-tenancy) [Prepare for Production\\ \\ Learn how to prepare your Inbox for production by enabling HMAC encryption for security and managing Novu's branding.](https://docs.novu.co/platform/inbox/prepare-for-production)

### On this page

[Install the React SDK package](https://docs.novu.co/#install-the-react-sdk-package) [Add the `NovuProvider`](https://docs.novu.co/#add-the-novuprovider) [Fetch and display notifications](https://docs.novu.co/#fetch-and-display-notifications) [Show notification counts](https://docs.novu.co/#show-notification-counts) [Adding notification actions](https://docs.novu.co/#adding-notification-actions) [Showing product updates banner](https://docs.novu.co/#showing-product-updates-banner) [Real-time updates](https://docs.novu.co/#real-time-updates) [Using websocket events](https://docs.novu.co/#using-websocket-events)

Copy page as markdown[Edit this page on GitHub](https://github.com/novuhq/docs/edit/main/content/docs/platform/inbox/headless-mode.mdx)Open in ChatGPTOpen in Claude