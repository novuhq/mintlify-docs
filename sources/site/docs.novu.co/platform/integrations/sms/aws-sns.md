# Source: https://docs.novu.co/platform/integrations/sms/aws-sns
...
## [Create User](https://docs.novu.co/#create-user)
...
## [Create an AWS SNS integration with Novu](https://docs.novu.co/#create-an-aws-sns-integration-with-novu)
...
[Africa's Talking\\ \\ Learn how to use the Africa's Talking provider to send sms notifications using Novu](https://docs.novu.co/platform/integrations/sms/africas-talking) [Azure SMS\\ \\ Learn how to use the Azure SMS provider to send sms notifications using Novu](https://docs.novu.co/platform/integrations/sms/azure)

### On this page

[Getting Started](https://docs.novu.co/#getting-started) [Create User](https://docs.novu.co/#create-user) [Create an AWS SNS integration with Novu](https://docs.novu.co/#create-an-aws-sns-integration-with-novu)

Copy page as markdown[Edit this page on GitHub](https://github.com/novuhq/docs/edit/main/content/docs/platform/integrations/sms/(providers)/aws-sns.mdx)Open in ChatGPTOpen in Claude