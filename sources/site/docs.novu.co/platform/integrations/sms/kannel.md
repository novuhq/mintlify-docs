...
## [Setting up Kannel](https://docs.novu.co/#setting-up-kannel)
...
## [Creating a Kannel integration with Novu](https://docs.novu.co/#creating-a-kannel-integration-with-novu)
...
[Gupshup\\ \\ Learn how to use the Gupshup SMS provider to send SMS notifications using Novu](https://docs.novu.co/platform/integrations/sms/gupshup) [Kudosity\\ \\ Learn how to use the Kudosity (formerly BurstSMS) provider to send sms notifications using Novu](https://docs.novu.co/platform/integrations/sms/kudosity)

### On this page

[Setting up Kannel](https://docs.novu.co/#setting-up-kannel) [Creating a Kannel integration with Novu](https://docs.novu.co/#creating-a-kannel-integration-with-novu)

Copy page as markdown[Edit this page on GitHub](https://github.com/novuhq/docs/edit/main/content/docs/platform/integrations/sms/(providers)/kannel.mdx)Open in ChatGPTOpen in Claude