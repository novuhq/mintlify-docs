# Source: https://docs.novu.co/platform/integrations/email/activity-tracking
...
## [How activity tracking works](https://docs.novu.co/#how-activity-tracking-works)
...
## [How to enable activity tracking](https://docs.novu.co/#how-to-enable-activity-tracking)

First [create the integration](https://docs.novu.co/platform/integrations/email/adding-email). After that, you can enable activity tracking by following these steps:
...
4. Scroll down to find the **Email Activity Tracking** section and click the toggle to enable it. ![Enable the inbound webhook](https://docs.novu.co/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fenable-inbound.e823ff83.png&w=3840&q=75) When enabled, Novu will auto-configure delivery webhooks using your existing API key. ![Inbound webhook enabled](https://docs.novu.co/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Finbound-enabled.fa87ac9b.png&w=3840&q=75)

## [Manual configuration](https://docs.novu.co/#manual-configuration)
...
[**Amazon SES**\\ \\ Manual configuration for Amazon SES Email Activity Tracking](https://docs.novu.co/platform/integrations/email/activity-tracking/manual-configuration/ses) [**Mailgun**\\ \\ Manual configuration for Mailgun Email Activity Tracking](https://docs.novu.co/platform/integrations/email/activity-tracking/manual-configuration/mailgun) [**SendGrid**\\ \\ Manual configuration for SendGrid Email Activity Tracking](https://docs.novu.co/platform/integrations/email/activity-tracking/manual-configuration/sendgrid) [**Resend**\\ \\ Manual configuration for Resend Email Activity Tracking](https://docs.novu.co/platform/integrations/email/activity-tracking/manual-configuration/resend)

## [Event semantics in Novu](https://docs.novu.co/#event-semantics-in-novu)
...
## [Supported providers and events](https://docs.novu.co/#supported-providers-and-events)
...
### [SendGrid](https://docs.novu.co/#sendgrid)
...
### [Mailgun](https://docs.novu.co/#mailgun)
...
### [Resend](https://docs.novu.co/#resend)
...
### [Amazon SES](https://docs.novu.co/#amazon-ses)
...
## [Viewing event data](https://docs.novu.co/#viewing-event-data)
...
### [Activity feed](https://docs.novu.co/#activity-feed)
...
### [Outbound webhooks integration](https://docs.novu.co/#outbound-webhooks-integration)
...
[Custom SMTP\\ \\ Learn how to use the Custom SMTP provider to send email notifications using Novu](https://docs.novu.co/platform/integrations/email/custom-smtp) [Amazon SES\\ \\ A step-by-step guide to manually configure Amazon SES with Novu for email activity tracking.](https://docs.novu.co/platform/integrations/email/activity-tracking/manual-configuration/ses)

### On this page

[How activity tracking works](https://docs.novu.co/#how-activity-tracking-works) [How to enable activity tracking](https://docs.novu.co/#how-to-enable-activity-tracking) [Manual configuration](https://docs.novu.co/#manual-configuration) [Event semantics in Novu](https://docs.novu.co/#event-semantics-in-novu) [Supported providers and events](https://docs.novu.co/#supported-providers-and-events) [SendGrid](https://docs.novu.co/#sendgrid) [Mailgun](https://docs.novu.co/#mailgun) [Resend](https://docs.novu.co/#resend) [Amazon SES](https://docs.novu.co/#amazon-ses) [Viewing event data](https://docs.novu.co/#viewing-event-data) [Activity feed](https://docs.novu.co/#activity-feed) [Outbound webhooks integration](https://docs.novu.co/#outbound-webhooks-integration)

Copy page as markdown[Edit this page on GitHub](https://github.com/novuhq/docs/edit/main/content/docs/platform/integrations/email/activity-tracking/index.mdx)Open in ChatGPTOpen in Claude