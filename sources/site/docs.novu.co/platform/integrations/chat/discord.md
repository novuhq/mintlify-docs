# Source: https://docs.novu.co/platform/integrations/chat/discord
...
[Chat\\ \\ Configure and manage chat providers like Slack, Microsoft Teams, WhatsApp, and Discord with Novu's notification infrastructure.](https://docs.novu.co/platform/integrations/chat) [Mattermost\\ \\ Learn about how to use Mattermost provider for chat notifications](https://docs.novu.co/platform/integrations/chat/mattermost)

### On this page

No Headings

Copy page as markdown[Edit this page on GitHub](https://github.com/novuhq/docs/edit/main/content/docs/platform/integrations/chat/(providers)/discord.mdx)Open in ChatGPTOpen in Claude