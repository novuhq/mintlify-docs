...
- **Inactive**: This means the workflow is paused. It cannot be triggered, but you can still edit its structure or steps.
  ![Active workflow](/images/workflows/configure-workflow/active-workflow.gif)
...
![Add tags](/images/workflows/configure-workflow/add-tags.gif)
...
![Manage payload schema manually](/images/workflows/configure-workflow/workflow-payload.gif)
...
![Import from JSON](/images/workflows/configure-workflow/import-payload.gif)
...
![Create inline variable](/images/workflows/configure-workflow/inline-variable.gif)
