...
![Injecting workflow context](/images/workflows/add-and-configure-steps/action-steps/http-step/add-http-step.gif)
...
![Injecting workflow context](/images/workflows/add-and-configure-steps/action-steps/http-step/configuring-the-request.gif)
...
![Testing the HTTP request](/images/workflows/add-and-configure-steps/action-steps/http-step/testing-endpoint.gif)
...
![Consuming the API response](/images/workflows/add-and-configure-steps/action-steps/http-step/using-response-in-step-conditions.gif)
