...
![Create and manage variables](/images/platform/environment-variables/create-a-variable.gif)
...
![Using variables in workflows](/images/platform/environment-variables/using-variable-in-email.gif)
