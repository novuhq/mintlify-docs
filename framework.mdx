...
<Columns cols={2}>
  <Card title="Next.js" icon="node-js" href="/framework/quickstart/nextjs" />
  <Card title="Express.js" icon="node-js" href="/framework/quickstart/express" />
  <Card title="Remix" icon="react" href="/framework/quickstart/remix" />
  <Card title="NestJS" icon="node-js" href="/framework/quickstart/nestjs" />
  <Card title="Svelte" icon="js" href="/framework/quickstart/svelte" />
  <Card title="Nuxt" icon="vuejs" href="/framework/quickstart/nuxt" />
  <Card title="H3" icon="node-js" href="/framework/quickstart/h3" />
  <Card title="Lambda" icon="aws" href="/framework/quickstart/lambda" />
</Columns>
