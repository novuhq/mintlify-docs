...
<Columns cols={2}>
  <Card title="Clerk" icon="react" href="/guides/webhooks/clerk">
  <p>
    Use Clerks webhooks events to trigger authentication related notifications workflows.
  </p>
  </Card>
  <Card title="Stripe" icon="stripe" href="/guides/webhooks/stripe">
  <p>
...
<Columns cols={2}>
  <Card title="Segment" icon="chart-simple" href="/guides/webhooks/segment">
  <p>
